...
VALID_REPORT = {'report_meta': {'scan_target': 'environment', 'scanned': ['/usr/local/lib/python3.9/site-packages'],
                ...
                'scanned_packages': {'safety': {'name': 'safety', 'version': '2.0b1', 'spec': '==2.0b1'},
                                     'click': {'name': 'click', 'version': '8.0.4', 'spec': '==8.0.4'},
        ...
        {'vulnerability_id': '25853', 'package_name': 'insecure-package', 'ignored': False, 'ignored_reason': None,
         ...
         'all_vulnerable_specs': ['<0.2.0'], 'analyzed_version': '0.1.0', 'analyzed_spec': '==0.1.0',
        ...
        'insecure-package': {'current_version': '0.1.0', 'current_spec': '==0.1.0',
                             'vulnerabilities_found': 1, 'recommended_version': None,
                             'other_recommended_versions': [],
                             'more_info_url': 'https://pyup.io/packages/pypi/insecure-package/'}}}

SCANNED_PACKAGES = {
    'safety': Package(name='safety', version='2.0b1', spec=SpecifierSet('==2.0b1')),
    'click': Package(name='click', version='8.0.4', spec=SpecifierSet('==8.0.4')),
    'insecure-package': Package(name='insecure-package', version='0.1.0', spec=SpecifierSet('==0.1.0')),
}

VULNS = [Vulnerability(vulnerability_id='25853', package_name='insecure-package',
                       pkg=Package(name='insecure-package', version='0.1.0',
                                   spec=SpecifierSet('==0.1.0'),
                                   found=None,
