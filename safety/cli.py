...
from safety.auth import inject_session, proxy_options, auth_options
...
from safety.constants import BAR_LINE, CONFIG_FILE_USER, CONFIG_FILE_SYSTEM, EXIT_CODE_VULNERABILITIES_FOUND, \
    EXIT_CODE_OK, EXIT_CODE_FAILURE
...
@cli.command(cls=SafetyCLILegacyCommand,
             context_settings={"command_type": CommandType.UTILITY},
...
cli.add_command(typer.main.get_command(init_app), "init")
...
cli.add_command(typer.main.get_command(pip_app), "pip")
