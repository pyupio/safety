...
class TestScanCommand(unittest.TestCase):
    ...
    def test_url_parameter_handling(self):
        ...
        test_cases = [
            ...
            ("https://platform.safetycli.com/project/test", "master", "https://platform.safetycli.com/project/test?branch=master"),
            # URL with existing parameters
            ("https://platform.safetycli.com/project/test?env=prod", "feature-branch", "https://platform.safetycli.com/project/test?env=prod&branch=feature-branch"),
            # URL with multiple existing parameters
            ("https://platform.safetycli.com/project/test?env=prod&org=myorg", "main", "https://platform.safetycli.com/project/test?env=prod&org=myorg&branch=main"),
        ]
