...
class TestMeta(unittest.TestCase):
    ...
    def test_get_user_agent_values(self, mock_get_version, mock_python_version, 
        ...
        user_agent = get_user_agent()
        self.assertEqual(user_agent, "safety-cli/3.0.1 (Windows unknown_arch; Python/3.10.0)")
        
        # Test with no version
        mock_get_version.return_value = None
        
        user_agent = get_user_agent()
        self.assertEqual(user_agent, "safety-cli/unknown (Windows unknown_arch; Python/3.10.0)")
    ...
    def test_get_meta_http_headers_includes_user_agent(self, mock_get_identifier, mock_get_version):
    ...
    def test_get_meta_http_headers_complete(self):
        ...
        required_headers = ["User-Agent", "Safetycli-Client-Version", "Safetycli-Client-Id"]
