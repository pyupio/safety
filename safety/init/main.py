...
def create_project(ctx: typer.Context, console: Console, target: Path) -> Tuple[bool, Optional[str]]:
    """
    ...
    if ctx.obj.platform_enabled:
        result = verify_project(console, ctx, session, unverified_project, stage, origin)
