...
def should_build_binary(os_type: str | None, python_version: str | None, target: str | None, config: dict) -> bool:
  ...
  try:
    ...
    return (
      ...
      target in artifacts_config.get('targets', []) and
      os_type in artifacts_config.get('os_type', [])
    )
  except KeyError:
    return False
